    ...
    <div class="container-fluid my-auto">
      <div class="row">
          <div class="col-lg-6 my-auto">
              <h1 class="display-3 font-weight-bold">Information Management System</h1>
              <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nesciunt suscipit accusamus, ratione doloribus, qui fugiat neque provident autem facilis laboriosam iste! Excepturi reprehenderit corrupti nulla doloribus optio dolorum tenetur error.</p>
 ...
 <section class="py-5 bg-light">
   ...
   <div class="text-center mb-5">
     <h2 class="font-weight-bold">Internships</h2>
      <p class="text-muted"><b>Summer Internship!</b></p>
      <p> what are you waiting for? Participate now and start applying to internships before others!</p>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 mb-4">
          <div class="card">
            <div>
               <img src="./assets/images/school-work-gf2570a5b6_1280.jpg" alt="" class="img-fluid rounded-top">
            </div>
            <div class="card-body">
                <b>Web Desing & Development</b>
                <p class="card-text">
...
<section class="py-5">
  <div class="text-center mb-5">
    <h2 class="font-weight-bold">Our Departments</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pr-5">
          ...
          <img src="./assets/images/chi.jpg" alt="" class="img-fluid rounded">
        </div>
        <div class="col-lg-6 my-auto">
          <div class="row">
