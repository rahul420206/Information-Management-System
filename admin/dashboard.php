      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <a href="http://localhost/ims/admin/user-account.php?user=student">
              <div class="info-box">
          ...
          <!-- /.col -->
          <div class="col-12 col-sm-6 col-md-3">
          <a href="http://localhost/ims/admin/user-account.php?user=teacher">
          ...
          <div class="col-12 col-sm-6 col-md-3">
          <a href="http://localhost/ims/admin/courses.php">
            <div class="info-box mb-3">
