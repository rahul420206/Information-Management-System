...
if(isset($_GET['delete'])){
  ...
  mysqli_query($db_conn, "DELETE FROM posts WHERE id = '$period_id'") or die('DB error');
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="edit_period.php?id=<?= $period->id ?>" class="btn btn-info btn-xs">Edit</a>
                          <a href="?delete=<?=$period->id?>" class="btn btn-danger btn-xs">Delete</a>
                        </td>
                      </tr>
