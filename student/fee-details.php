            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo $action?>" method="post" name="payuForm">
                        <input type="hidden" name="surl" value="http://localhostims/actions/success.php" size="64" />
        
		                <input type="hidden" name="furl" value="http://localhost/ims/actions/failure.php" size="64" />
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstname" readonly class="form-control" value="<?php echo get_users(array('id'=>$std_id))[0]->name ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">Email Address</label>
                                    <input type="email" name="email" readonly class="form-control" value="<?php echo get_users(array('id'=>$std_id))[0]->email ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="month" readonly class="form-control" id="month" value="<?php echo get_users(array('id'=>$std_id))[0]->month ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <h3><i class="fa fa-rupee-sign"></i> 50.00</h3>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
