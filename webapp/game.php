...
rollBtn1.addEventListener("click", function() {
  if (currentPlayer === 1) {
    ...
    updateScore1(score);
    rollBtn2.disabled = false; // enable player 2's roll button
    rollBtn1.disabled = true; // disable player 1's roll button
  }
});
...
rollBtn2.addEventListener("click", function() {
  if (currentPlayer === 2) {
    var score = generateScore();
    updateScore2(score);
    rollBtn1.disabled = false; // enable player 1's roll button
    rollBtn2.disabled = true; // disable player 2's roll button
  }
});
